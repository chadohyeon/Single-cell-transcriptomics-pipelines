...
saveRDS(resList[["query"]], paste0("/home/dcha/02.glioblastoma_scRNAseq/rdata/cca_transfer/ccaTrans_",queryName,"_", rdsObj))
saveRDS(resList[["ref"]], paste0("/home/dcha/02.glioblastoma_scRNAseq/rdata/cca_transfer/ccaTrans_",refName,"_", rdsObj))
saveRDS(resList[["query_mnn"]], paste0("/home/dcha/02.glioblastoma_scRNAseq/rdata/cca_transfer/ccaTrans_mnn_",queryName,"_", rdsObj))
saveRDS(resList[["ref_mnn"]], paste0("/home/dcha/02.glioblastoma_scRNAseq/rdata/cca_transfer/ccaTrans_mnn_",refName,"_", rdsObj))
