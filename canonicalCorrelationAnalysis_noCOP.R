...
if(sctNorm=="y"){
  ...
  sctNorm=FALSE
  prep="logNorm"}
merged_human_mouse=readRDS(paste0("/home/dcha/02.glioblastoma_scRNAseq/rdata/musHom_noCOP/",rdsObj))
...
saveRDS(ccaRes, paste0("/home/dcha/02.glioblastoma_scRNAseq/rdata/musHom_noCOP/seurat_cca_",prep, "_", rdsObj))
saveRDS(ccaRes_MNN, paste0("/home/dcha/02.glioblastoma_scRNAseq/rdata/musHom_noCOP/seurat_cca_",prep, "_mnn_", rdsObj))
