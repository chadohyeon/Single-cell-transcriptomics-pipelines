...
opcRoot.obj = obj.fastmnn_finalAnnot %>% subset(., subset=celltype%in%c("OPC", "pre-CC1", "CC1-A"))

#pag=readRDS("/home/dcha/02.glioblastoma_scRNAseq/rdata/pag_precc1_cc1A.rds")
...
saveRDS(gsvaOut, "precc1_cc1A.pag.gsva.scenic.rds")
