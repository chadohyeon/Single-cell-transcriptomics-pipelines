...
saveRDS(resList[["query"]], paste0("/home/dcha/02.glioblastoma_scRNAseq/rdata/cca_transfer_noCOP/cca_sct_Trans_",queryName,"_", rdsObj))
saveRDS(resList[["ref"]], paste0("/home/dcha/02.glioblastoma_scRNAseq/rdata/cca_transfer_noCOP/cca_sct_Trans_",refName,"_", rdsObj))
