...
gs_list=readRDS("/home/dcha/02.glioblastoma_scRNAseq/rdata/scenic_tf_set.rds")

obj.fastmnn_finalAnnot=readRDS("/home/dcha/02.glioblastoma_scRNAseq/rdata/obj.fastmnn_finalAnnot.rds")
opcRoot.obj = obj.fastmnn_finalAnnot %>% subset(., subset=celltype%in%c("OPC", "pre-CC1", "CC1-B1", "CC1-B2"))

#pag=readRDS("/home/dcha/02.glioblastoma_scRNAseq/rdata/pag_precc1_cc1B.rds")
pag=readRDS("/home/dcha/02.glioblastoma_scRNAseq/rdata/opc_pag.rds")
...
saveRDS(gsvaOut, "precc1_cc1B.pag.gsva.scenic.rds")
